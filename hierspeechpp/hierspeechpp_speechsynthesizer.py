...
import hierspeechpp.activations as activations
...
class ResidualCouplingBlock_Transformer(nn.Module):
    def __init__(self,
        ...
        for i in range(n_flows):
            self.flows.append(
                modules.ResidualCouplingLayer_Transformer_simple(channels, hidden_channels, kernel_size, dilation_rate,
...
class PosteriorSFEncoder(nn.Module):
    def __init__(self,
        ...
        self.source_enc = modules.WN(hidden_channels, kernel_size, dilation_rate, n_layers // 2,
                                     gin_channels=gin_channels)
        self.filter_enc = modules.WN(hidden_channels, kernel_size, dilation_rate, n_layers // 2,
                                     gin_channels=gin_channels)
