...
import hierspeechpp.ttv_v1.attentions as attentions
from hierspeechpp.commons import init_weights

from hierspeechpp.ttv_v1 import modules
from hierspeechpp.ttv_v1.modules import WN
from hierspeechpp.ttv_v1.styleencoder import StyleEncoder
...
class ResidualCouplingBlock_Transformer(nn.Module):
  def __init__(self,
    ...
    for i in range(n_flows):
      self.flows.append(
        modules.ResidualCouplingLayer_Transformer_simple(channels, hidden_channels, kernel_size, dilation_rate, n_layers, gin_channels=gin_channels, mean_only=True, attention_head=4))
